...
export const mockActivities: Activity[] = [
  ...
  { id: "act-c002-1", clientId: "c002", type: "stage_change", date: "2026-04-22T08:00:00Z", note: "Entered pipeline as a referral from existing client.", agentName: "Errikos Kohls", metadata: { from: "—", to: "New Inquiry" } },
  { id: "act-c002-2", clientId: "c002", type: "phone_call", date: "2026-04-21T14:30:00Z", note: "Initial call to introduce the agency. Sophie confirmed budget up to €3.5M and preference for Naoussa area.", agentName: "Errikos Kohls", metadata: { duration: "18 min" } },
  { id: "act-c002-3", clientId: "c002", type: "email", date: "2026-04-21T16:00:00Z", note: "Follow-up email with curated Naoussa and Golden Beach seafront listings PDF.", agentName: "Errikos Kohls" },
  { id: "act-c002-4", clientId: "c002", type: "note", date: "2026-04-20T09:00:00Z", note: "Internal note: Referred by Jean-Pierre Fontaine. High intent, looking to purchase before summer.", agentName: "Errikos Kohls" },
  ...
  // c004 · James Whitmore
  { id: "act-c004-1", clientId: "c004", type: "stage_change", date: "2026-04-19T08:00:00Z", note: "Lead from Instagram ad campaign — clicked on Cycladic village listing.", agentName: "Errikos Kohls", metadata: { from: "—", to: "New Inquiry", source: "Instagram Ad" } },
  { id: "act-c004-2", clientId: "c004", type: "email", date: "2026-04-19T16:30:00Z", note: "Sent automated welcome email. Followed up manually with Cycladic house listings in Lefkes and Marpissa.", agentName: "Errikos Kohls" },
  { id: "act-c004-3", clientId: "c004", type: "phone_call", date: "2026-04-18T11:00:00Z", note: "Attempted callback — no answer. Left voicemail.", agentName: "Errikos Kohls", metadata: { duration: "—", outcome: "Voicemail left" } },
  // c005 · Yael Ben-David
  { id: "act-c005-1", clientId: "c005", type: "stage_change", date: "2026-04-16T10:00:00Z", note: "Moved to Qualified stage after confirming liquid funds and purchase intent.", agentName: "Errikos Kohls", metadata: { from: "New Inquiry", to: "Qualified" } },
  { id: "act-c005-2", clientId: "c005", type: "phone_call", date: "2026-04-18T11:00:00Z", note: "Qualification call completed. Confirmed budget €5M–€10M, liquid. Looking for private estate with direct sea access. Timeline: purchase within 6 months.", agentName: "Errikos Kohls", metadata: { duration: "35 min" } },
  { id: "act-c005-3", clientId: "c005", type: "meeting", date: "2026-04-14T09:00:00Z", note: "Video call meeting to discuss requirements in detail. Shared mood-board of preferred estate styles. Agreed on north-coast focus for initial shortlist.", agentName: "Errikos Kohls", metadata: { duration: "55 min", platform: "Zoom" } },
  { id: "act-c005-4", clientId: "c005", type: "email", date: "2026-04-12T13:00:00Z", note: "Sent initial inquiry response with ultra-luxury estate shortlist. Three properties highlighted in Naoussa, Ambelas, and Kamares.", agentName: "Errikos Kohls" },
  { id: "act-c005-5", clientId: "c005", type: "note", date: "2026-04-10T08:30:00Z", note: "High-priority A-class client. Requires concierge-level service. Security and privacy are key concerns — no public listings to be shared.", agentName: "Errikos Kohls" },
  ...
  { id: "act-c009-1", clientId: "c009", type: "stage_change", date: "2026-04-17T09:00:00Z", note: "Advanced to Property Presentation — Villa Aegean Crest PDF sent and acknowledged.", agentName: "Errikos Kohls", metadata: { from: "Qualified", to: "Property Presentation" } },
  { id: "act-c009-2", clientId: "c009", type: "document", date: "2026-04-16T09:00:00Z", note: "Sent full property PDF for Villa Aegean Crest, Naoussa — 4 bed, seafront, infinity pool, €3.9M asking.", agentName: "Errikos Kohls", metadata: { file: "villa-aegean-crest-brochure.pdf" } },
  { id: "act-c009-3", clientId: "c009", type: "viewing", date: "2026-04-14T10:00:00Z", note: "Virtual walkthrough conducted via video call. Alexander expressed strong interest in the sea-facing terrace and master suite layout.", agentName: "Errikos Kohls", metadata: { format: "Virtual" } },
  { id: "act-c009-4", clientId: "c009", type: "meeting", date: "2026-04-10T14:00:00Z", note: "Strategy meeting to narrow shortlist to two top contenders. Alexander confirmed maximum €4.5M — no compromise on seafront position.", agentName: "Errikos Kohls", metadata: { duration: "45 min", platform: "WhatsApp Video" } },
  { id: "act-c009-5", clientId: "c009", type: "phone_call", date: "2026-04-07T11:00:00Z", note: "Qualification call — confirmed liquid funds and German bank financing already pre-arranged.", agentName: "Errikos Kohls", metadata: { duration: "30 min" } },
  // c010 · Rachel Cohen
  ...
  // c011 · Oliver Hartley
  { id: "act-c011-1", clientId: "c011", type: "stage_change", date: "2026-04-06T09:00:00Z", note: "Moved to Property Presentation — exclusive compound listings prepared for Oliver's review.", agentName: "Errikos Kohls", metadata: { from: "Qualified", to: "Property Presentation" } },
  { id: "act-c011-2", clientId: "c011", type: "note", date: "2026-04-11T10:00:00Z", note: "In-person viewing scheduled for late April. Oliver arriving by private jet — arrange transfer and Naoussa accommodation.", agentName: "Errikos Kohls", metadata: { arrival: "28 Apr 2026" } },
  { id: "act-c011-3", clientId: "c011", type: "document", date: "2026-04-08T09:00:00Z", note: "Sent confidential property dossier covering three off-market north-coast estates. NDA signed and on file.", agentName: "Errikos Kohls", metadata: { file: "hartley-confidential-estates-dossier.pdf", nda: "Signed 07 Apr 2026" } },
  { id: "act-c011-4", clientId: "c011", type: "meeting", date: "2026-04-05T11:00:00Z", note: "Strategy meeting in London with Oliver and his PA. Discussed requirements: 6+ beds, helipad or large parking, absolute privacy.", agentName: "Errikos Kohls", metadata: { location: "London — Claridge's", duration: "90 min" } },
  // c012 · Henrik Larsson
  ...
  { id: "act-c014-1", clientId: "c014", type: "stage_change", date: "2026-04-10T09:00:00Z", note: "Entered Negotiation stage — counter-offer received from seller at €4.2M vs asking €4.8M.", agentName: "Errikos Kohls", metadata: { from: "Offer Submitted", to: "Negotiation" } },
  { id: "act-c014-2", clientId: "c014", type: "note", date: "2026-04-08T10:00:00Z", note: "Counter-offer received: seller holding at €4.5M. David's limit is €4.3M. Exploring inclusion of boat dock and furniture in deal.", agentName: "Errikos Kohls", metadata: { seller_counter: "€4,500,000", client_limit: "€4,300,000" } },
  { id: "act-c014-3", clientId: "c014", type: "phone_call", date: "2026-04-06T11:00:00Z", note: "Strategy call with David — agreed to counter at €4.2M with boat dock and external furniture included.", agentName: "Errikos Kohls", metadata: { duration: "40 min" } },
  { id: "act-c014-4", clientId: "c014", type: "offer", date: "2026-04-03T14:00:00Z", note: "Initial offer of €3.9M submitted on Ambelas peninsula estate. Asking was €4.8M.", agentName: "Errikos Kohls", metadata: { amount: "€3,900,000", property: "Ambelas Estate", asking: "€4,800,000" } },
  { id: "act-c014-5", clientId: "c014", type: "viewing", date: "2026-03-28T10:00:00Z", note: "Exclusive viewing of Ambelas peninsula estate. David confirmed this is his top choice.", agentName: "Errikos Kohls", metadata: { duration: "3 hours" } },
  ...
  { id: "act-c016-1", clientId: "c016", type: "stage_change", date: "2026-03-29T09:00:00Z", note: "Entered Legal Process stage — notary engaged and title search initiated.", agentName: "Errikos Kohls", metadata: { from: "Negotiation", to: "Legal Process" } },
  { id: "act-c016-2", clientId: "c016", type: "document", date: "2026-04-06T09:00:00Z", note: "Title search report received — property is clear of encumbrances. Notary appointment confirmed for April 20.", agentName: "Errikos Kohls", metadata: { file: "title-search-deVries.pdf", notary_date: "20 Apr 2026" } },
  { id: "act-c016-3", clientId: "c016", type: "meeting", date: "2026-04-02T11:00:00Z", note: "Meeting with Pieter and notary Konstantina Daskalopoulou to review preliminary contract.", agentName: "Errikos Kohls", metadata: { location: "Paros Notary Office" } },
  { id: "act-c016-4", clientId: "c016", type: "document", date: "2026-03-31T14:00:00Z", note: "Preliminary contract (προσύμφωνο) drafted and reviewed by both parties. Deposit of €100K transferred.", agentName: "Errikos Kohls", metadata: { file: "preliminary-contract-deVries.pdf", deposit: "€100,000" } },
  ...
  { id: "act-c018-1", clientId: "c018", type: "stage_change", date: "2026-04-23T09:00:00Z", note: "Deal completed — signed and closed at €9.4M on exclusive Naoussa seafront estate.", agentName: "Errikos Kohls", metadata: { from: "Legal Process", to: "Signed & Closed" } },
  { id: "act-c018-2", clientId: "c018", type: "meeting", date: "2026-04-03T16:00:00Z", note: "Final signing meeting at Paros notary. All parties present. Contracts signed, keys handed over. Champagne served on site.", agentName: "Errikos Kohls", metadata: { location: "Naoussa Notary" } },
  { id: "act-c018-3", clientId: "c018", type: "document", date: "2026-04-01T11:00:00Z", note: "Final contract (κυρία σύμβαση) signed and notarized. Full payment of €9.4M confirmed received.", agentName: "Errikos Kohls", metadata: { file: "final-contract-bergmann.pdf", amount: "€9,400,000" } },
  { id: "act-c018-4", clientId: "c018", type: "phone_call", date: "2026-03-25T10:00:00Z", note: "Pre-closing call — reviewed all outstanding documents. Wire transfer confirmed for April 1.", agentName: "Errikos Kohls", metadata: { duration: "20 min" } },
